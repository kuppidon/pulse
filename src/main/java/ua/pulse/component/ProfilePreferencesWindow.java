...
//
//    private ProfilePreferencesWindow(final UserBean user,
...
//
//                    PulseEventBus.post(new ProfileUpdatedEvent());
//                    close();
...
//    }
//
//    public static void open(final UserBean user,
//                            final boolean preferencesTabActive) {
//        PulseEventBus.post(new CloseOpenWindowsEvent());
